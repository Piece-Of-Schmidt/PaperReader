...
class PortfolioMaker(FPDF):
    ...
    def header(self):
        ...
        """
        self.set_font('DejaVu', 'B', 10)  # Schriftgröße von 12 auf 10 reduziert
    ...
    def footer(self):
        ...
        """
        self.set_y(-25)  # Position an neuen unteren Rand angepasst
    ...
    def chapter_title(self, title):
        ...
        """
        self.set_font('DejaVu', 'B', 14)  # Schriftgröße von 16 auf 14 reduziert
    ...
    def chapter_body(self, body):
        ...
        """
        self.set_font('DejaVu', '', 10)  # Schriftgröße von 11 auf 10 reduziert
    ...
    def add_toc(self):
        ...
        self.ln(10)
        self.set_font('DejaVu', '', 10)  # Schriftgröße von 12 auf 10 reduziert
    ...
    def build_pdf_portfolio(self):
        ...
        self.add_page()
        self.set_font('DejaVu', 'B', 20)  # Schriftgröße von 24 auf 20 reduziert
        self.cell(0, 20, 'Portfolio', new_x=XPos.LEFT, new_y=YPos.NEXT, align='C')
        self.ln(20)
        self.set_font('DejaVu', 'I', 10)  # Schriftgröße von 12 auf 10 reduziert
